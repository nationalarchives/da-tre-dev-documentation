...
![pic2](./diagrams/tre-exchange-messages-option1.png)

## Option-2 - Single SNS topic with AWS EventBridge 

### AWS EventBridge

![pic3](./diagrams/aws-EventBridge_How-it-works.png)
...
![pic3](./diagrams/tre-exchange-messages-option2.png)

## Option-3 - Multiple SNS topics and SQS queues with fan-out

TO DO

![pic4](./diagrams/tre-exchange-messages-option3.png)
